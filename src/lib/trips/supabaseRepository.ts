...
const EXPENSE_COLUMNS = `id, trip_id, item_id, title, amount, currency, payer_member_id, spent_on, created_at, mode, category, resolved, expense_shares(${EXPENSE_SHARE_COLUMNS})`;
