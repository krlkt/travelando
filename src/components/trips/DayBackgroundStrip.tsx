      ...
      {items.map((item) => {
        ...
        return (
          <button
            ...
            className={cn(
              'border-border/60 bg-secondary/30 hover:border-foreground/15 focus-visible:ring-ring/60 group relative flex items-center gap-2.5 rounded-[var(--radius)] border px-3 py-2 text-left transition-[transform,box-shadow,border-color] hover:-translate-y-[1px] hover:shadow-[0_10px_24px_-18px_oklch(20%_0.02_250_/_0.25)] focus-visible:ring-2 focus-visible:outline-none',
