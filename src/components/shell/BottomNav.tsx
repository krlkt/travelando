...
export function BottomNav() {
  ...
  return (
    <nav
      aria-label="Primary"
      className="bg-background/80 border-border/60 fixed inset-x-0 bottom-0 z-40 border-t px-3 pt-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] backdrop-blur-2xl md:hidden"
    >
          ...
          return (
            <li key={tab.href} className="flex-1">
              <Link
                ...
                className="focus-visible:ring-ring/60 relative flex flex-col items-center gap-1 rounded-full px-2 py-2 outline-none focus-visible:ring-2"
              >
                {active && (
                  <motion.span
